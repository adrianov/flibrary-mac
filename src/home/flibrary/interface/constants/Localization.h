...
constexpr auto DO_NOT_ASK_AGAIN = QT_TRANSLATE_NOOP("Common", "Don't ask again");
...
constexpr auto PublishYears = QT_TRANSLATE_NOOP("Navigation", "PublishYear");
...
constexpr auto PUBLISH_YEAR = QT_TRANSLATE_NOOP("Annotation", "PublishYear:");
