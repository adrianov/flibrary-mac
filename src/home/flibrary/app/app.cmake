...
if(APPLE)
	...
	add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
		...
		COMMAND ${CMAKE_COMMAND} -E copy "$<TARGET_FILE:opds>" "${_opds_bin}"
		...
		COMMAND "${CMAKE_SOURCE_DIR}/cmake/run_macdeployqt.sh"
			"${MACDEPLOYQT_EXECUTABLE}" "${_app_bundle}"
			"-libpath=${_qt_lib_dir}"
			"-executable=${_opds_bin}"
		COMMAND ${CMAKE_COMMAND} -Dsrc="${CMAKE_BINARY_DIR}/lib" -Ddst="${_app_frameworks}" -P "${CMAKE_SOURCE_DIR}/cmake/copy_bundle_libs.cmake"
