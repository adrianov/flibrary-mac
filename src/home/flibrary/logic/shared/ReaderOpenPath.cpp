...
constexpr auto EPUB_CACHE_VERSION = "v20";
...
void RemoveLegacyCache(long long bookId)
{
	...
	for (const auto& suffix :
	     { QString(), QStringLiteral(".v2"), QStringLiteral(".v3"), QStringLiteral(".v4"), QStringLiteral(".v5"), QStringLiteral(".v6"), QStringLiteral(".v7"), QStringLiteral(".v8"), QStringLiteral(".v9"), QStringLiteral(".v15"), QStringLiteral(".v16"), QStringLiteral(".v17"), QStringLiteral(".v18"), QStringLiteral(".v19") })
