...
#ifdef __APPLE__
constexpr auto FONT_SIZE_DEFAULT = 13;
#else
...
constexpr auto INP_FIELDS_DESCRIPTION_DEFAULT     = "AUTHOR;GENRE;TITLE;SERIES;SERNO;FILE;SIZE;LIBID;DEL;EXT;DATE;INSNO;LANG;LIBRATE;KEYWORDS;YEAR;SOURCELIB;";
